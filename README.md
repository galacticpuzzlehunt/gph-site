...
- ... provide the site in my language?
  ...
  + set LANGUAGE_CODE in base/settings.py as lang-country
  + example for English: translations under locale/en_US, formats under gph/formats/en, LANGUAGE_CODE = 'en-us'
